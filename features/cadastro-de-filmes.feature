...
Funcionalidade: Cadastro de filmes
    ...
    Esquema do Cenario: Novo filme
        ...
        Quando eu faço um cadastro deste filme
        Então deve ver o filme no catalogo
    ...
    Esquema do Cenario: Campos obrigatórios 
        O gestor de catálogo tentar cadastrar um novo filme, mas 
        esquece de preencher um dos campos obrigatórios, em seguida, o sistema
    ...
    Cenario: Duplicado
        ...
        já foi cadastrado em outro momento e o sistema notifica usuário
